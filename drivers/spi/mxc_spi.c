...
static int __board_spi_cs_gpio(unsigned bus, unsigned cs)
{
	return -1;
}
int board_spi_cs_gpio(unsigned bus, unsigned cs)
	__attribute__((weak, alias("__board_spi_cs_gpio")));
 ...
 * To use this feature you have to define CONFIG_MXC_SPI_CS_GPIOS with
